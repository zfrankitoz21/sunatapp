	...
	<div id="container">
		...
		<div class="right-list-admin">
			<ul class="list-menu">
				...
				<li><a class="active" href="<?=base_url()?>index.php/provincias"><i class="fa fa-cubes"></i> Administración de Provincias</a></li>
			</ul>
		</div>
	    ...
	    <div class="right-content">	
	        <div class="list-mod-panel">
				...
				<h2><a href="<?=base_url()?>/index.php/provincias">Regresar a Provincias</a></h2>
			</div>
		...
		<?php if ( $data )
			echo form_open_multipart('provincias/edit/' . $data->id);
		else
			echo form_open_multipart('provincias/add');
		?>
			<table class="table table-bordered table-striped">
				<tr>
					<td>Nombre : </td><td><input type="text" name="nombre" value="<?=@$data->nombre?>"></td>
				</tr>
				<tr>
					<td>Número de destacadas : </td><td><input type="text" name="ndestacadas" value="<?=@$data->ndestacadas?>"></td>
				</tr>
				<tr>
